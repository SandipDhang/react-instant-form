...
import InstantForm from "../components/InstantForm/InstantForm";
import * as Yup from "yup";

const stories = storiesOf("InstantForm", module);

const CustomInput = ({ value, handleChange }) => (
  <input placeholder="fname" value={value} onChange={handleChange} />
);
